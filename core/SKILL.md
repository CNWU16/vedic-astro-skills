...
在所有宫位诊断完成后，输出一份**通俗语言的完整总结报告**。要求:
- 用大白话解释,让不懂占星的普通人也能看懂
- 每个板块要有具体的比喻和生活化类比
- 涵盖以下十大板块:

```
一、你是谁 — 底层人格分析(上升+Sun+Moon的协作效应,用日常语言写)
二、事业 — 10宫完整解读(为什么启动慢/适合什么类型/何时打开)
三、婚姻 — 7宫完整解读(资源量/管理者状态/时间窗口)
四、海外方向 — 9宫/12宫/Moon综合判读(该不该出/什么时候出)
五、社交与赚钱 — 11宫/2宫联动(变现路径特征)
六、Yogakaraka — 如有,详解其落陷/增强的具体代价与补偿
七、AK灵魂课题 — 灵魂这辈子来学什么,通过什么渠道落地
八、D9品质总评 — 灵魂层的底子好不好,一句话总结
九、Dasha时间轴 — ASCII图表展示当前→未来关键节点,标注⭐转折点
十、关键提醒 — 3-5条实操建议,直接可用
```
